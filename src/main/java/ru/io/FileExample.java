...
public class FileExample {
    public static void main(String[] args) throws IOException {
        File directory = new File("src/main/java/ru/io/files");
        directory.mkdir();
        File file =  new File("src/main/java/ru/io/files/file.txt");
        file.createNewFile();
        ...
        File newFile = new File("src/main/java/ru/io/files/newFile.txt");
