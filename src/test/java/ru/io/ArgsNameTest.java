...
class ArgsNameTest {
    ...
    @Test
    void whenStringDoesntContainsKeyThenExceptionThrown() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-=512", "-request=msg=HelloWorld"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
    ...
    @Test
    void whenStringDoesntContainsValueThenExceptionThrown() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xms=", "-request=msg=HelloWorld"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
    ...
    @Test
    void whenStringDoesntContainsAnEqualsSignThenExceptionThrown() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xms:512", "-Xms=512"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
