...
class NonCollisionMapTest {
    ...
    @Test
    void whenGetNullThenExpectedResult() {
        map.put(null, "777");
        assertThat(map.get(null)).isEqualTo("777");
    }

    @Test
    void whenGetAfterExpandThenExpectedResult() {
        map.put(5, "5");
        map.put(6, "6");
        map.put(7, "7");
        map.put(8, "8");
        map.put(9, "9");
        assertThat(map.get(9)).isEqualTo("9");
    ...
    @Test
    void whenPut10ElementsThenMapExpand() {
        for (int i = 5; i <= 10; i++) {
            map.put(i, "i");
        }
    ...
    @Test
    void whenPutExistingElementThenFalse() {
    ...
    @Test
    void whenRemoveNullThenSuccessful() {
        map.put(null, "654");
    ...
    @Test
    void whenRemoveAfterExpandThenSuccesfull() {
        for (int i = 5; i <= 10; i++) {
            map.put(i, "i");
        }
        assertThat(map.remove(10)).isTrue();
        assertThat(map.remove(9)).isTrue();
    ...
    @Test
    void whenIteratorAfterPutAndRemoveThenElementsInExpectedOrder() {
        map.remove(4);
        map.put(null, "4");
        assertThat(map).containsExactly(null, 1, 2, 3);
    }
