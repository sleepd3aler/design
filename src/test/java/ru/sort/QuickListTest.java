...
class QuickListTest {
    ...
    @Test
    void whenAllIdAreSameThenSameResult() {
        ...
        QuickList.quickSort(list, comparator);
        System.out.println(list);
        assertThat(list).containsExactly(-2, -2, -2, -2, -2, -2, -2);
    }

    @Test
    void whenAlphabeticThenOk() {
        User user1 = new User(1, "Alex");
        User user2 = new User(1, "LeroooooyJenkins");
        User user3 = new User(3, "Silvana");
        User user4 = new User(-4, "Arthas");
        User user5 = new User(4, "Uter");
        User user6 = new User(6, "Nerzul");
        ...
        assertThat(result).containsExactly("Alex", "Arthas", "LeroooooyJenkins", "Nerzul", "Silvana", "Uter");
    }
